...
從E到P的除以W運算中，我們發現這是個線性關係，可以用**直線方程式**來定義 y=mx+b
...
處理P點跟N點的關係,Xp的範圍為[l,r], Xn的範圍為[-1,1]，**P點跟N點都是同屬一個點**，只是在不同Coordinates中有不同的標示。 有點難以想像的是，我們眼睛所看到的錐形範圍會變成方形畫面,但卻是如此。
...
![](image/OrthographicFrustumAndNdc.png)
